...
public class BigGun : MonoBehaviour
{
    ...
    [SerializeField] private float fireRate = 5f;           // how fast turret shoots
    ...
    [SerializeField] private float turnSpeed = 5f;          // how fast the turret turns
    ...
    private void Shoot()
    {
        ...
        BigGunBullet bullet = bulletGO.GetComponent<BigGunBullet>();                                            // gets Bullet script
