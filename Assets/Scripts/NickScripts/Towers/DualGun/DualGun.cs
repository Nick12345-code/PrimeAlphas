...
public class DualGun : MonoBehaviour
{
    ...
    [SerializeField] private float range = 10f;             // range of turret
    [SerializeField] private float fireRate = 10f;          // how fast turret shoots
    ...
    private void Shoot()
    {
        ...
        DualGunBullet bullet = bulletGO.GetComponent<DualGunBullet>();                                      // gets Bullet script
